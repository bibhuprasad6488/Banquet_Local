                                    ...
                                    <div class="row">
                                        @if (!empty($venue->amenity_datas))
                                            @foreach ($venue->amenity_datas as $key => $val)
                                                <div class="col-md-1 col-sm-2 col-2 m-1 text-center "
                                                    style="color: #ff5b61;">
                                                    @if (!empty($val->icon))
            ...
            <div class="container">
                <div class="row mt-4">
                    <div class="col-md-11 m-auto acc ">
                        ...
                        @if (!empty($faq))
                            @foreach ($faq as $k => $v)
                                <button class="accordion" data-toggle="collapse" data-parent="#accordion"
                                    href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"
                                    onclick="changeIcon(this)">{{ $v->title }}<i
                                        class="material-symbols-outlined fa fa-plus"></i></button>
                                ...
                                <div class="col-lg-12 ">
                                    <div class="row">
                                        ...
                                        <div class=" col-sm-6  col-md-3 col-6">
                                            <label for="example-text-input" id="demo"
    ...
    <script>
        $('#butsave').on('click', function() {
            ...
            if (customer_name == '' || customer_name == null || customer_name == undefined || room_no == '' ||
                ...
                anniversary == '' || anniversary == null || anniversary == undefined || staff == '' || staff ==
                null ||
                staff == undefined || service == '' || service == null || service == undefined || vibe == '' ||
                vibe ==
