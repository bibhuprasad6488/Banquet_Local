                ...
                <div class="row">
                    <div class="col-md-12 m-auto text-center ">
                        <div class="btn-group mx-2">
                            <a href="/banquet/all-venues" class="btn  m-1">Go to Home <i
                                    class="fa-solid fa-house mx-1"></i></a>
                        </div>
                        <div class="btn-group mx-2">
                            <a href="/banquet/profile" class="btn  m-1">Go to Profile <i
                                    class="fa-solid fa-user mx-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
