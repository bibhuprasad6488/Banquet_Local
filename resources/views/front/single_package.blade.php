            ...
            <div class="container p-0">
                <div class="row">
                    <div class="col-12 p-4">
                        <div class="row">
                            <div class="col-md-6">
                                <h5 class="pl-4">Select any <span id="itmmxqty"></span><span id="appit"></span> :
                                </h5>
                            </div>
                            <div class="col-md-6">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        @if ($cart_cat_id != null && $cart_package_id != null)
                                            ...
                                            <input type="hidden" id="hdn_package_id" value="{{ $cart_package_id }}">
                                        @else
                                            <input type="hidden" id="hdn_cat_id"
                                        ...
                                        @if (!empty($cats))
                                            ...
                                            <nav class="mt-3">
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    <a class="nav-item nav-link act" href="javascript::void(0);"
                                                        style="border-radius: 50px !important;border-radius: 20px !important; padding: 4px 15px 4px 13px !important;margin: 1px 3px 1px 2px; background-color: #ff5b61; color: #fff;"
                                                        aria-selected="true" id="sts">Indian</a>
                                ...
                                <div class="car bg-gray border-bottom border-danger pb-2">
                                    <div class=" card-body py-1 px-2 d-flex">
                                        ...
                                        <div class="p-2 flex-shrink-1 col-sm-4">
                                            <img src="{{ asset('front/assets/img/content.jpg') }}" alt=""
                                                class="img-responsive float-right " width="90px" height="80px">
                                            <a class="nav-item nav-link act" href="javascript::void(0);"
                                                aria-selected="true" id="add_remove">ADD</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-row">
                            <div class="col-md-6">
                                <a href="#" class="bg-transparent border-none" id="backward"><i
                                        class="fa-solid fa-arrow-left"></i> Back</a href="#">
                            </div>
